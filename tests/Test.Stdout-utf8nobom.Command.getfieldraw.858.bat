@echo off
    ...
    rem must have same output as Test.Stdout-utf8nobom.Command.getfieldraw.65001.bat
    call "%~dp0Utils\Utils.test-setup.bat" "%~f0" "%~dp0Test.Stdout-utf8nobom.Command.getfieldraw.65001.bat"

    "%KeePassCommandExe%" getfieldraw -stdout-utf8nobom "Unicode Entry@Notes ‚n Õ–r•" "ExtraField@Notes ‚n Õ–r•" > "%KeePassCommand_TestOutput%"
